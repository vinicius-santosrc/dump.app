    ...
    return (
        <>
                ...
                <div className="dump-post-show">
                    <div className="dump-post-show">
                        <div className="dump-post-header-show">
                            <Link to={window.location.origin}><i className="fa-solid fa-chevron-left"></i></Link>
                            <img src={window.location.origin + '/static/media/dumplogo.f3r818ht813gh78t13t.webp'} />
                            <label><i className="fa-regular fa-bookmark"></i></label>
                        </div>
            ...
            <div className="dump-post-show-mobile">
                ...
                <div className="dump-post-show">
                    <div className="dump-post-header-show">
                        <Link href={window.location.origin}><i className="fa-solid fa-chevron-left"></i></Link>
                        <img src={window.location.origin + '/static/media/dumplogo.f3r818ht813gh78t13t.webp'} />
                        <label><i className="fa-regular fa-bookmark"></i></label>
                    </div>
                    <div className="dump-post-options">
